...
export const handlers = [
  ...
  http.post(`${API_BASE_URL}/api/v1/auth/login`, async ({ request }) => {
    ...
    if (reqJson.email === "patient@example.com") {
      // Patient user
      mockJwt = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiIxMjMiLCJlbWFpbCI6InRlc3RAZW1haWwuY29tIiwidXNlclR5cGUiOiJwYXRpZW50In0.mock-signature";
    } else if (reqJson.email === "staff@email.com") {
      // Staff user
      mockJwt = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJzdGFmZiIsImVtYWlsIjoic3RhZmZAZW1haWwuY29tIiwidXNlclR5cGUiOiJzdGFmZiJ9.mock-signature";
    } else if (reqJson.email === "doctor@email.com") {
      // Doctor user
      mockJwt = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJkb2MxIiwiZW1haWwiOiJkb2N0b3JAZW1haWwuY29tIiwidXNlclR5cGUiOiJkb2N0b3IifQ.mock-signature";
    } else {
  ...
  http.get(
    `${API_BASE_URL}/api/v1/bookings/patients/:patientId`,
    () => {
      return HttpResponse.json([
        {
          id: "b1",
