...
describe("CancelBookingModal", () => {
  ...
  expect(screen.getByText(/are you sure you want to cancel your appointment/i)).toBeInTheDocument();
});

  it("does not render when closed", () => {
    render(<CancelBookingModal open={false} onClose={() => {}} />);
    expect(screen.queryByText(/are you sure you want to cancel your appointment/i)).not.toBeInTheDocument();
  });
